...
class ProfileScreenComponent extends StatelessWidget {
  ...
  ProfileScreenComponent(this.informationModel);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            Stack(
              children: <Widget>[
                _BackgroundCircularImageChampion(informationModel),
                _BadgeProfileIcon(informationModel),
                _TextSummonerName(informationModel),
                _TextSummonerLevel(informationModel),
                _TextSummonerRegion(informationModel),
                _TextSummonerKDA(informationModel),
                _BadgeRankSummoner(informationModel),
                _TextRankSummoner(),
              ],
            ),
            _TopSummonerChamps(informationModel),
            SizedBox(
              height: 45.0,
            ),
            _TextLastGames(),
            _LastGamesScroll(informationModel),
          ],
        ),
      ),
    );
